...
def main():
    ...
    file_name = args["--in"]
    password = args["--pass"]
    audio_output_file= "temp/audio.mp3"
    input_frame_folder= "temp"
    ...
    if args['encode']:
        ...
        extract_audio_from_video(file_name, audio_output_file)
        ...
        merge_frames_to_video(input_frame_folder, fileout)
        # cpFile(file_name, input_frame_folder)
        # cpFile(textfile, input_frame_folder)        
        ...
        merge_audio_to_video(fileout, audio_output_file, fileout)
